...
def chatbot1(query):
   ...
   with open(r'F:\empathyai\Intents.json') as fileobj:
   ...
   history = model.fit(np.array(train_x),np.array(train_y),epochs=10,batch_size=1,verbose=7)
